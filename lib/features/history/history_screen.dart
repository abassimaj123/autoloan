  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final shown   = hasFull ? all : all.take(freemiumService.historyLimit).toList();
        final locked  = all.length - shown.length;
        return _buildScaffold(context, l10n, adService,
            history, all, shown, locked, hasFull);
      },
    );
  }
              ...
              onPressed: () async {
                final confirm = await showDialog<bool>(
                  ...
                  builder: (_) => AlertDialog(
                    ...
                    content: Text('Clear all ${all.length} calculation${all.length == 1 ? '' : 's'}? This cannot be undone.'),
                    actions: [
                      TextButton(
      ...
      body: all.isEmpty
          ...
          : ListView(
              ...
              children: [
                ...
                if (!hasFull && locked == 0 && shown.length >= freemiumService.historyLimit)
                  Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  if (termMonths != null)
                    _Tag(icon: Icons.calendar_today_outlined, label: '${termMonths ~/ 12} yr'),
                  _Tag(icon: Icons.percent, label: '${rate.toStringAsFixed(1)}%'),
                  if (province != null)
                    _Tag(icon: Icons.location_on_outlined, label: province),
