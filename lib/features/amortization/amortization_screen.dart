...
class _PayoffChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxBalance = rows.first.balance + rows.first.principal + rows.first.interest;
    ...
    final fmt = NumberFormat.compactCurrency(symbol: currencySymbol, decimalDigits: 0);
