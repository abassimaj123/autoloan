    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: Icon(Icons.calculate_outlined, color: _accentColor, size: 22),
        ),
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            const Text('Also from us', style: TextStyle(fontSize: 10, color: Color(0xFF64748B))),
          ]),
          const SizedBox(height: 2),
          const Text(_targetName, style: TextStyle(
              fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF1E293B))),
          const Text(_targetTagline, style: TextStyle(
