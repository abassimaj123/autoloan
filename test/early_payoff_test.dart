...
void main() {
  ...
  test('[EP-3] Extra \$100/mo saves interest vs no extra', () {
    ...
    expect(
      interestWithExtra,
      lessThan(interestNoExtra),
      reason: '[EP-3] Extra payment reduces total interest',
    );
    expect(
      interestNoExtra - interestWithExtra,
      greaterThan(100.0),
  ...
  test('[EP-6] monthsSaved = term - earlyPeriods > 0 for extra > 0', () {
    ...
    expect(monthsSaved, greaterThan(0), reason: '[EP-6] Positive months saved');
    expect(
      monthsSaved,
      lessThan(term),
